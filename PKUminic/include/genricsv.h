...
void Visit_bin_cond(const koopa_raw_value_t &value, std::ostream &outfile, int &register_num, std::map<koopa_raw_value_t, int> &map_reg);
...
void handle_left_right_reg(const koopa_raw_value_t &value, std::ostream &outfile, std::string &leftreg, std::string &rightreg,
                           std::string &eqregister, int &register_num, std::map<koopa_raw_value_t, int> &map_reg);
std::string get_reg_(const koopa_raw_value_t &value, std::map<koopa_raw_value_t, int> &map_reg);
